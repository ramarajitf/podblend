...
function my_enqueue_assets() {
    ...
    wp_enqueue_script( 'jquery-3.6.1', get_template_directory_uri() . '/assets/js/jquery-3.6.1.js', array(), '1.0.0', true);
    wp_enqueue_script( 'owl.carousel', get_template_directory_uri() . '/assets/js/owl.carousel.js', array(), '1.0.0', true);
    wp_enqueue_script( 'custom-script', get_template_directory_uri() . '/assets/js/custom-script.js', array(), '1.0.0', true);
}
